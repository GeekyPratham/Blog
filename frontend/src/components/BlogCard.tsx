...
export const BlogCard = ({
  ...
  return (
    <div className="flex justify-between items-start border-b border-gray-700 pb-6 mb-6 max-w-4xl bg-gray-900 text-gray-100 rounded-xl p-4 shadow-md shadow-violet-500/10 hover:shadow-violet-400/20 transition duration-300">
      {/* Left Section */}
